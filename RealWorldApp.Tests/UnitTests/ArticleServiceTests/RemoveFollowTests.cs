...
{
    public class RemoveFollowTests
    {
        ...
        [Category("RemoveFollow")]
        [Test]
        public async Task RemoveFollow_WithCorrectData_ReturnArticleResponseModelContainer()
        {
            // ARRANGE
            ...
            // ACT
            var result = await articleService.UnFavorite("slug", claimsPrincipal);

            // ASSERT
            Assert.IsFalse(result.Article.Favorited);
